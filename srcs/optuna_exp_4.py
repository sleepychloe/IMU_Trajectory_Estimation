...
from autotune import calc_score_quasi_ori_from_seg, suggest_timevarying_gate_sigma

def exp_4_1(seg: list[tuple[int, int]],
            dt: ScalarBatch, q_ref: QuatBatch,
...
def exp_4_2(seg: list[tuple[int, int]],
            dt: ScalarBatch, q_ref: QuatBatch,
            w: Vec3Batch, a: Vec3Batch, m: Vec3Batch,
            best_quasi_static: tuple[int, int, int],
            tau_candidate: tuple[float, float],
...
def exp_4_3(seg: list[tuple[int, int]],
            dt: ScalarBatch, q_ref: QuatBatch,
            w: Vec3Batch, a: Vec3Batch, m: Vec3Batch,
            best_quasi_static: tuple[int, int, int],
            tau_candidate: tuple[float, float],
...
def exp_4_4(seg: list[tuple[int, int]],
            dt: ScalarBatch, q_ref: QuatBatch,
            w: Vec3Batch, a: Vec3Batch, m: Vec3Batch,
            best_quasi_static: tuple[int, int, int],
            tau_candidate: tuple[float, float],
...
def exp_4_5(seg: list[tuple[int, int]],
            dt: ScalarBatch, q_ref: QuatBatch,
...
def exp_4_6(seg: list[tuple[int, int]],
            dt: ScalarBatch, q_ref: QuatBatch,
            g0: float, sigma_floor: float,
            w: Vec3Batch, a: Vec3Batch, m: Vec3Batch,
            best_quasi_static: tuple[int, int, int],
